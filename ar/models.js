        ...
        <article class="card card--media model-card">
          ...
          <div class="body">
            <div class="model-card__head">
              ...
              <span class="model-card__arabic" aria-hidden="true">${m.nameLatin}</span>
            </div>
            <p class="model-card__meaning"><em>${m.meaning}</em></p>
            <p class="model-card__desc">${m.description}</p>
            <div class="meta">
              <span>الطول<strong>${m.length}</strong></span>
              <span>السعة<strong>${m.capacity}</strong></span>
            </div>
